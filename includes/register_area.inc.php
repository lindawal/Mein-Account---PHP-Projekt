...
if (!isset($_SESSION["name"])) {
  echo " <div class='login_card'><form action='" . htmlspecialchars($_SERVER['PHP_SELF']) . "' method='POST'>
    ...
    "<br> Du hast bereits Zugangsdaten? 
          <a href='index.php?page=login_area'>Zum Login gehts hier entlang...</a></p></div>";
} else {

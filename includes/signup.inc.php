<div>
  ...
  <div class='login_area'>
    <div class='login_card'>
      ...
      //Das Objket User_Edit bereits zu beginn laden, damit dieses dann an das Formular Objekt übergeben werden kann
    ...
    document.getElementById('counterdiv').innerHTML = counter}, 1000);        
      ...
      <a href='
      <?PHP echo linkTo("index.php", "?page=login"); ?>
      '>Zum Login gehts hier entlang...</a>
    </div>
  </div>
</div>